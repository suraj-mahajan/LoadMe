...
(function(window){'use strict';
    ...
    function LoadMeAction(){
            if("undefined"==typeof jQuery){
                throw new Error("LoadMe.js requires jQuery");
            }
            
            var LoadMe = {};
            
            LoadMe.open = function(properties){
                ...
                switch(theme){
                    ...
                    default:
                        content = '<div class="sk-rect"> <div class="rect1"></div> <div class="rect2"></div> <div class="rect3"></div> <div class="rect4"></div> <div class="rect5"></div> </div>';
                        console.warn(theme + " doesn't exist for LoadMe.js");
                    break;
                }
